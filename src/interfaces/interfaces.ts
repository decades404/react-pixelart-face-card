...
export type EyesAccessoryTypes =  string | 'none' | 'eyes-accessory-1' | 'eyes-accessory-2' | 'eyes-accessory-3' | 'eyes-accessory-4' | 'eyes-accessory-5'| 'eyes-accessory-6'| 'eyes-accessory-7'| 'eyes-accessory-8'| 'eyes-accessory-9' | 'eyes-accessory-10' ;
...
export type HairTypes =  string  | 'none'| 'hair-1' | 'hair-2'| 'hair-3'| 'hair-4'| 'hair-5' | 'hair-6'| 'hair-7' | 'hair-8'| 'hair-9'| 'hair-10'| 'hair-11' | 'hair-12'| 'hair-13'| 'hair-14'| 'hair-15'| 'hair-16'| 'hair-17' | 'hair-18' | 'hair-19' | 'hair-20' | 'hair-21' | 'hair-22' | 'hair-23' | 'hair-24' | 'hair-25' | 'hair-26' | 'hair-27' | 'hair-28' | 'hair-29' | 'hair-30' ;
...
export type MouthTypes =  string  | 'none' | 'mouth-1' | 'mouth-2'  | 'mouth-3' | 'mouth-4' ;
...
export type BeardTypes =  string | 'none' | 'beard-1' | 'beard-2' | 'beard-3' | 'beard-4' | 'beard-5'  | 'beard-6' | 'beard-7' | 'beard-8' | 'beard-9' | 'beard-10'    ;
